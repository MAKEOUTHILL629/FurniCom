...
<body>
  <header id="principal-header">
    ...
    <nav id="nav-container" class="navbar navbar-expand navbar-light bg-light shadow-sm">
      <div class="collapse navbar-collapse" id="navbarNav ">
        <ul id="nav-items" class="navbar-nav d-flex justify-content-center w-100 pb-4">
          <li class="nav-item">
  ...
  <main id="principal-main">
    <section id="main-img" class="d-flex align-items-end">
      <h1 class="main-title w-100">¡La modestia y elegancia echa a la medida!</h1>
    </section>
  </main>
