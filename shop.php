            ...
            <div class="row">
              <div class="col-12 col-sm-6 col-lg-4">
                ...
                <div class="card item-shop">
                  <a href=""><img src="presentation/img/products/el_1.jpg" class="img-fluid" alt="..."></a>
                  ...
                  <div class="card-body">
                    ...
                    <div class="d-flex w-100 justify-content-between align-items-center pe-2">
                      ...
                      <div>
                        <a href="" class="btn shadow-sm plus-button rounded-circle"><i class="fas fa-search"></i></a>
                      </div>
                    </div>
                  </div>
                </div>
