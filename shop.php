    ...
    <main id="shop-main" class="shadow position-relative overflow">
        ...
        <div class="container-fluid h-100 px-2">
            <div class="row justify-content-center align-items-center shadow-sm pt-3 mb-3 bg-sec">
                <h3 class="text-center text-white">Sillas <img src="presentation/img/icons/silla.svg"
                                                               class="furniture-icon" alt="icon_silla"></h3>
            </div>
            <div class="row">
                            ...
                            foreach ($products as $item) {
                                ...
                                <div class="col-12 col-sm-6 col-lg-4">
                                    <div class="card item-shop">
                                        <a href="product.php"><img src="<?php echo $images[0]->getPath() ?>"
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="d-flex w-100 justify-content-between align-items-center pe-2">
                                                ...
                                                <div>
                                                    <a href="product.php"
                                                       class="btn shadow-sm plus-button rounded-circle"><i
