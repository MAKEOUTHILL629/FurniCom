                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">509</div>
                                        </div>
                                        <div class="col-auto">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-4 col-lg-5">
                            <div class="card shadow mb-4">
                                <!-- Card Header - Dropdown -->
                                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                    <h6 class="m-0 font-weight-bold text-primary">Stock de Categorías</h6>
                                    <div class="dropdown no-arrow">
                                        <a class="dropdown-toggle" href="#" role="button" id="dropdownMenuLink"
                                           data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                            <i class="fas fa-ellipsis-v fa-sm fa-fw text-gray-400"></i>
                                ...
                                $categoriesStock = new CategoryByStock();
                                $categoresStocks = $categoriesStock->consultAllCategoriesWithName();
                                ?>
                                <div class="card-body">
                                    ...
                                    <div class="mt-4 text-center small">
                                        ...
                                        for ($i = 0; $i < 4; $i++) {
                                            ...
                                            ?>
                                            <span class="mr-2">
                                         <?php echo $categoresStocks[$i]->getNameCategory() ?>
                                    </span>
                                            <?php
                                        }
                                        ?>
...
<?php require_once "presentation/platform/layouts/modal.php" ?>
    ...
    <!-- Page level plugins -->
    <script src="presentation/vendor/chart.js/Chart.min.js"></script>
    ...
    <script>
        ...
        $salesMonth = new SalesMonth();
        $salesMonths = $salesMonth->salesByMonth();
        $labelsMonths = "";
        $sales = "";
        foreach ($salesMonths as $foo) {
            $labelsMonths .= '"' . $foo->getMonth() . '",';
            $sales .= "" . $foo->getSales() . ", ";
        }
