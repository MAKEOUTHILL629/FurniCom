              ...
              <div class="card item-shop">
                ...
                <div class="card-body">
                  ...
                  <div class="d-flex w-100 justify-content-between align-items-center pe-2">
                    ...
                    <div>
                      <a href="index.php?pid=<?php echo base64_encode("presentation/product.php") ?>&product=test" class="btn shadow-sm plus-button rounded-circle"><i class="fas fa-search"></i></a>
                    </div>
                  </div>
                </div>
              </div>
