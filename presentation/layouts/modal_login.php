      ...
      <div class="modal-body px-5 py-3">
        ...
        <form action="#">
          <div class="input-group input-group-lg py-2">
            <span class="input-group-text d-flex justify-content-center" id="inputGroup-sizing-default" style="width:40px"><i class="fas fa-id-card"></i></span>
            <input type="text" class="form-control rounded-left" placeholder="Username">
          </div>
          <div class="input-group input-group-lg py-2">
            <span class="input-group-text d-flex justify-content-center" id="inputGroup-sizing-default" style="width:40px"><i class="fas fa-lock"></i></span>
            <input type="password" class="form-control rounded-left" placeholder="Password">
          </div>
          <div class="input-group input-group-lg py-3 px-5">
            <button type="submit" class="form-control btn common-button rounded submit h-100 px-3">Inicia sesión</button>
          </div>
...
<div class="modal fade" style="overflow-y:hidden !important;" id="registerModal" tabindex="-1" aria-labelledby="registerModal" aria-hidden="true">
      ...
      <div class="modal-body px-5 py-0">
        ...
        <form>
          ...
          <div class="input-group d-flex pb-2 justify-content-center">
            <button type="submit" class="form-control btn common-button rounded submit h-100" style="max-width:200px !important">Registrarse</button>
          </div>
        </form>
      </div>
      <div class="modal-footer justify-content-center bg-light">
