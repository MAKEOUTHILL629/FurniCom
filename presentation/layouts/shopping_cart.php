        ...
        <div class="px-5 py-4 shadow rounded">
          <div class="container">
            <div class="row justify-content-center">
              ...
              <div class="col-5">
                <div class="row">
                  <h4 class="font-quik fw-bold w-auto">Sofá Cama Berlín <i class="fas fa-truck-loading ps-3"></i></h4>
                ...
                <div class="d-flex w-100 py-3">
                  <div class="d-flex justify-content-start w-100 align-items-center ">
                    ...
                    <div class="input-group" style="max-width:80px">
                      <input id="modal_cantidad" type="text" style="max-height:50px;" min="1" max="100" class="form-control m-0" value="1">
                    </div>
                  </div>
                </div>
              </div>
